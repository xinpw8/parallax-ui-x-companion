...
1. **NEVER mention Claude, AI, or any AI assistant in git commits. No co-author tags, no "Generated by", nothing. Clean commit messages only.**
2. **This dev environment runs in WSL but the Electron app runs on WINDOWS**
3. **After EVERY file edit, copy changes to Windows:**
   ```bash
   cp /home/daa/parallax/parallax-ui/<file> /mnt/c/Users/Daniel/parallax-ui/<file>
   ```
4. **Always include Windows (`win32`) support in platform-specific code**
